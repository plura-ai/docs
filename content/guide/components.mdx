...
<Accordion type="single" collapsible>
  <AccordionItem value="item-1">
    ...
    <AccordionContent>
      Yes! This is a fully functional accordion component that you can use in your documentation.
    </AccordionContent>
  </AccordionItem>
...
<LinkedCard href="/guide/installation">
...
```tsx
<LinkedCard href="/guide/getting-started">
  <h3>Getting Started →</h3>
  <p>Learn how to get started with our documentation components.</p>
</LinkedCard>
```
